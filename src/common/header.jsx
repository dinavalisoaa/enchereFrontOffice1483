...
function Header() {
   ...
   function miser(){
    navigate("/recherche?search="+keyWord);
   }
...
function search(){}
    return <div>
            ...
            <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                ...
                <ul class="navbar-nav flex-nowrap ms-auto">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <Link tag="a" className="nav-link" to="/listeEnchere">
                            <button className="btn btn-primary">
                        <i className="fa fa-text-width" aria-hidden="true"></i>Encheres</button>
                        </Link>
                        </div>
                    </li>
                    <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <Link tag="a" className="nav-link" to="/historique">
                            <button className="btn btn-primary">
                        <i className="fa fa-text-width" aria-hidden="true"></i> Historique</button>
                        </Link>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        <div class="nav-item dropdown no-arrow">
                        <Link tag="a" className="nav-link" to="/typography">
                            <button className="btn btn-primary">
                        <i className="fa fa-text-width" aria-hidden="true"></i> Logout</button>
                        </Link>
                        </div>
                    </li>
                </ul>
        ...
        <nav class="navbar navbar-expand-lg bg-light text-uppercase fixed-top" id="mainNav" style={{ "height": "100px" }}>

            {/* <nav class="navbar navbar-expand-lg navbar-dark bg-info" aria-label="Tenth navbar example"  id="mainNav"> */}
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="btn btn-warning" aria-current="page" href="#">
                            </a>
                        ...
                        <li class="nav-item">
                            {/* <Link tag="a" className="nav-link" to="/categorie">
                                    <button className="btn btn-danger">
                                        <i className="fa fa-text-width" aria-hidden="true"></i> HOME</button>
                                </Link> */}
                        </li>
                        <li class="nav-item">
                            {/* <Link tag="a" className="nav-link" to="/historique">
                                    <button className="btn btn-danger">Historique</button>
                                </Link> */}
                        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample09">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <Link tag="a" className="nav-link" to="/recherche">
                                <button className="btn btn-primary">
                                    Recherche</button>
                            </Link>
                        </li>
        ...
        <div class="container " >
            <nav class="navbar navbar-expand-lg navbar-light bg-light rounded" aria-label="Eleventh navbar example">
                <div class="container-fluid">
                    <div style={{ "marginInline": "300px" }} class="collapse navbar-collapse" id="navbarsExample09">
                      </div>
                </div>
            </nav>
        </div>
