...
//         fetch("http://localhost:8080/users/" + localStorage.getItem("id") + "/encheres", {
//             method: 'GET',
//             headers: {
...
//                     <div className="row">
//                         <div className="col">
//                             <h4 className="pb-2 mb-0">Historique</h4>
//                         </div>
...
//                             </div>
//                         </div>
//                         {ListeEnchere.map((values, index) => {
//                             return (
//                                 <div className="bd-example">
//                                     <div className="alert alert-default" role="alert">
//                                         <div class="grid-container">
//                                             <div><p><div className="profile-userpic">
...
//                                             <div>
//                                                 <h2><strong>
//                                                 {values.descriProduit}
                                                    
//                                                     </strong>  
//                                                </h2>
//                                                <h4 className="alert-heading">{values.cat?.nom}</h4>
                                                
//                                                 <h5>Prix minimale:{values.prixMin}</h5>
//                                                 <h5>Date de lancement:{values.dateDebut}</h5>
//                                                 <h3>Expirer:{values.durer}</h3>

//                                             </div>

//                                             <div>
//                                         <button className="btn btn-success">All Move</button>
//                                             </div>
